		        ...
		        <div class="panel-heading">
			        ...
			        <div class="col-sm-4">
			            <div class="input-group">
						      ...
						      <input type="text" class="form-control" placeholder="Search for leave" id="deptHeadSearch">
						</div>
					</div>
					</div>
		        </div>
			            ...
			            <div class="row">
			            	<div class="col-sm-4" id="columnOne">
				            	<div class="panel panel-primary">
						            ...
						            <div class="panel-body">
						              <p>Submitted by Employee<br></p>
						              <button type="button" class="btn btn-primary btn-group-sm" data-toggle="modal" data-target="#viewForm"> View Form </button>
						            </div>
						         </div>
						         <div class="panel panel-primary">
						            <div class="panel-heading">
