...
<!-- Alert messages -->
	...
	<div id="logoutConfirmation" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="logoutConfirmation" style="display: none;">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="logoutConfirmation">Logout Confirmation</h4>
				</div>
...
<!-- end Alert messages -->
		...
		<div class="dropdown pull-left" style="align:left;">
	        ...
	        <ul class="dropdown-menu" aria-labelledby="menuIcon" style="margin-left: 20px;">
			    <li><a href="hrDeptEmployeeDB.jsp">View Employee Database</a></li>
			    <li><a href="hrDeptLeaveDB.jsp">View Leave Database</a></li>
		    ...
		    <div class="panel panel-default">
		        <div class="panel-heading">
		        	<div class="row">
				        ...
				        <div class="col-sm-4">
				            <form class="navbar-form navbar-right" role="search" id="hrDeptSearch">
